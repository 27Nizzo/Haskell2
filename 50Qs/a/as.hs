...
-- 39
-- Por exemplo, elemMSett ’a’ [(’b’,2), (’a’,4), (’c’,1)] corresponde a True enquanto que elemMSett ’d’ [(’b’,2), (’a’,4), (’c’,1)] corresponde a False.
elemMSett :: Eq a => a -> [(a,Int)] -> Bool
elemMSett n [] = False
elemMSett n ((a,b):t)
    | n == a = True
    | otherwise = elemMSett n t


-- 40
-- Por exemplo, converteMSett [(’b’,2), (’a’,4), (’c’,1)] corresponde a "bbaaaac".
converteMSett :: [(a,Int)] -> [a]
converteMSett [] = []
converteMSett (h:t) = (converteMSett'aux h) ++ converteMSett t

converteMSett'aux (a,0) = []
converteMSett'aux (a,b) = a : converteMSett'aux (a,(b-1))



--41)

insereMSett:: Eq a => a -> [(a,Int)] -> [(a,Int)]
insereMSett n [] = [(n,1)]
insereMSett n ((a,b):t) | n == a = (a,(b+1)) : insereMSett t
                        | otherwise = (a,b) : insereMSett n t
...
constroiMSet'aux :: (Eq a, Num b) => (a, b) -> [a] -> ((a, b), [a])
...
partitionEitherss [] = ([], []) 
partitionEitherss ((Left a):t) = let (l,r) = partitionEitherss t
                in (a:l, r) 
partitionEitherss ((Right b):t) = let (l,r) = partitionEitherss t
                in (l,b:r)
...
catMaybess [] = []
catMaybess ((Just a):t) = a : catMaybess t
catMaybess (Nothing:t) = catMaybess t
